...
namespace MicroservicesDemo {
    public class HttpRequest {
        ...
        /// sending files over http. Use <see cref="MicroservicesDemo.PostFileInfo"/> for file parameters and 
        /// <see cref="MicroservicesDemo.PostValueParam"/> for standard string parameters
        /// </para>
        /// <para>
        /// Properties PostParams, MultipartPostParams, PostBody and PostBinaryBody are mutually exclusive
        /// use only one of them.
